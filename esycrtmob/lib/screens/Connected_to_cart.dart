//when a customer is connectED to a cart..this page is displayed.THis is not the page 
...
class CartSync extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CartSyncState(); //create state
  }
}
...
class _CartSyncState extends State<CartSync> {
  ...
  Future<MqttServerClient> connect() async {
    ...
    final connMessage = MqttConnectMessage()
        ...
        .withClientIdentifier("flutter_client");//Refer https://stackoverflow.com/questions/66181329/dart-mqtt-client-identifierrejected-and-a-disconnection-origin-of-none
...
// PING response received
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Connecting...."), backgroundColor: Colors.yellow),
      body: Container(
