...
//my own imports
import 'package:esycrt/components/horizontal_listview.dart';
import 'package:esycrt/components/Products.dart';
import 'package:esycrt/pages/on_the_way_orders.dart';
import 'package:esycrt/pages/delivery_orders.dart';
import 'package:esycrt/pages/shopping_list.dart';
          ...
          new IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => new on_the_way_orders()));
            },
          ),
          new IconButton(
            icon: Icon(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => new delivery_orders()));
            },
          )
        ],
      ),
            ...
            InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => new tasks()));
              },
              child: ListTile(
