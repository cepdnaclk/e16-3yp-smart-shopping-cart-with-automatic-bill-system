...
;var sh=w.ytLoggingGelSequenceIdObj_||{};x("ytLoggingGelSequenceIdObj_",sh,void 0);function th(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||R());e[a]=b;a=$f();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};P("log_sequence_info_on_gel_web")&&d.M&&(a=e.context,b=d.M,sh[b]=b in sh?sh[b]+1:0,a.sequence={index:sh[b],groupKey:b},d.La&&delete sh[d.M]);(d.Ik?lh:hh)({endpoint:"log_event",payload:e,C:d.C},c)}
...
a.level)a=0;else a:{a=dj();c=u(a.i);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Ck)){a=d.weight;break a}a=u(a.h);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ja(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(aj);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.sa[l.name])for(e=u(c.sa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+
